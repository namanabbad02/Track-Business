...
//     // Check if paymentts is a valid array, default to an empty array if not
//     const paymentts = Array.isArray(updatedData?.paymentts) ? updatedData.paymentts : [];

//     // Calculate total paymentts
//     const totalpaymentts = paymentts.reduce(
//       (total, payment) => total + parseFloat(payment.amount || 0),
//       0
//     );

//     // Calculate balance
//     const balance = parseFloat(updatedData?.Amount || 0) - totalpaymentts;
...
//     const updatedpaymentts = purchaserData.paymentts.map((payment, idx) =>
